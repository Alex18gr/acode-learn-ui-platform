...
const routes: Routes = [
  { path: '', component: AppComponent, canActivate: [AuthGuardHomeService] },
  {
    ...
    canActivate: [AuthGuardStudentService],
    children: [
  ...
  },
  {
    ...
    canActivate: [AuthGuardAuthenticatedService],
  },
  {
    path: 'instructor',
    component: InstructorComponent,
    canActivate: [AuthGuardInstructorService],
    children: [
        ...
        children: [
          { path: '', component: InstructorCourseListComponent },
          {
            ...
            children: [
              ...
              {
                path: 'sections',
                component: InstructorCourseSectionsComponent,
              },
              {
                path: 'resources',
                component: InstructorCourseResourcesComponent,
              },
              {
                path: 'settings',
                component: InstructorCourseSettingsComponent,
              },
            ],
          },
        ],
