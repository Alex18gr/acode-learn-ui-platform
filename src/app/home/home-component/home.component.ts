...
export class HomeComponent implements OnInit {
  ...
  myAnnouncements = [
    new Announcement(1, 1001, 'This is an important announcement!!!', 'The lesson of monday is canceled!!!', 'bob', new Date(1562675143)),
    new Announcement(2, 1001, 'Marks are announced', 'Come from my office on monday to get your marks', 'tom', new Date(1562025600)),
    new Announcement(3, 1002, 'New Task!!!', 'There is a new task with deadline 2 weeks. Check it on the tasks section',
    'john', new Date(1562544000)),
    new Announcement(4, 1002, 'Announcement!!!', 'The lesson of Tuesday is canceled!!!', 'alex', new Date(1562284800)),
    new Announcement(5, 1002, 'This is an important announcement!!!', 'The exam day is in one month. You can ask in the secretary.',
    'john', new Date(1562199000)),
    new Announcement(6, 1003, 'New Task', 'New task for monday', 'bob', new Date(1562371200)),
    new Announcement(7, 1002, 'This is an important announcement!!!', 'Professor will not be able to attend to the class tomorrow',
    'tom', new Date(1562198400)),
    new Announcement(8, 1003, 'New Exam Day', 'The exam date is changed!', 'bob', new Date(1562457600)),
    new Announcement(9, 1003, 'New Book', 'Check the new book at the university bookstore at the 1st floor', 'alex', new Date(1561939200))
  ];
